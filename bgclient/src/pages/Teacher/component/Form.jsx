...
import { Form, Input, Button, Space, Image, Upload, Radio } from 'antd'
import { PlusOutlined } from '@ant-design/icons'
import { isExist } from '../../../services/teacher'
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <Radio.Group onChange={e => updateInfo(e.target.value, 'permission')} value={userInfo.permission}>
                        <Radio value={'1'}>超级管理员</Radio>
                        <Radio value={'2'} defaultChecked>教师</Radio>
                    </Radio.Group>
